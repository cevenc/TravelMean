	 ...
	 protected void onCreate(Bundle savedInstanceState) {
		   ...
		   tralv.setOnItemClickListener(new OnItemClickListener(){
				 public void onItemClick(AdapterView<?> adapterView, View view, final int position,long id) {
					String[] dialoglist=getResources().getStringArray(R.array.tralist_dialoglist);
					 new AlertDialog.Builder(Travallist.this).setTitle(getResources().getString(R.string.operate)).setItems(
						     dialoglist, new OnClickListener(){
								@Override
